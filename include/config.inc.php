...
$cfg['soft_name'] = 'ProxyIP_Pool';
$cfg['soft_version'] = 'v1.0';
$cfg['soft_lang'] = 'UTF-8';
header("Content-Type: text/html; charset={$cfg['soft_lang']}");
$cfg['db_host'] = 'localhost:3306';	// 数据库服务器
...
$db = new Mysql($cfg['db_host'],$cfg['db_user'],$cfg['db_pass'],$cfg['db_name'],$cfg['db_charset'],$cfg['db_pre']);
